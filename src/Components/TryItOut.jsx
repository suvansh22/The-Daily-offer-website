...
export default function AddOffer(props){
  ...
  function StepperThree(props){
    ...
    const [finaldate,setFinaldate]=React.useState(0);
    ...
    const handleSubmit=async()=>{
      ...
      await DateAndTime('f');
        ...
        //let body={"sdate":startdate,"fdate":finaldate};
        //await postData('backend/practice',body);
    ...
    const onErr=(a,b)=>{
      if(a==='stime')
      {
        var comptime=new Date().getTime()+3600000;
      ...
      {
        var comptime=stime.getTime()+3600000;
        if(b.getTime()<comptime)
        {
          setErr({...err,b:true})
          primary.errorb=true
    ...
    function updateVar(){
      ...
      setStartdate(props.data2.sdate)
      setFinaldate(props.data2.sdate)
    ...
    return(
      ...
      Please, fill all information
          ...
          <Paper className={classes.root} style={{border:"3px black solid",height:"100%",width:"90%",background:"linear-gradient(#424242 , #90a4ae , #424242)"}}>
